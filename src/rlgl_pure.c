...
static Matrix FloatToMatrix(float *m);
...
void rlDrawRenderBatch(rlRenderBatch *batch)
{
    ...
    for (int eye = 0; eye < eyeCount; eye++)
    {
        if (eyeCount == 2)
        {
            ...
            rlSetMatrixModelview(MatrixToFloat(rlMatrixMultiply(matModelView, RLGL.State.viewOffsetStereo[eye])));
            // Set current eye projection matrix
            rlSetMatrixProjection(MatrixToFloat(RLGL.State.projectionStereo[eye]));
        }
...
void rlSetUniformMatrix(int locIndex, float *mat)
{
#if defined(GRAPHICS_API_OPENGL_33) || defined(GRAPHICS_API_OPENGL_ES2)
//    float matfloat[16] = {
...
void rlGetMatrixModelview(float *out)
{
...
//    matrix = RLGL.State.modelview;
    float16 result = MatrixToFloatV(RLGL.State.modelview);
    memcpy(out, result.v, 16 * sizeof(float));
#endif
//    return matrix;
}

// Get internal projection matrix
void rlGetMatrixProjection(float *out)
{
#if defined(GRAPHICS_API_OPENGL_11)
//    float mat[16];
...
//    return RLGL.State.projection;
    float16 result = MatrixToFloatV(RLGL.State.projection);
    memcpy(out, result.v, 16 * sizeof(float));
#endif
}

// Get internal accumulated transform matrix
void rlGetMatrixTransform(float *out)
{
...
RLAPI void rlGetMatrixProjectionStereo(int eye, float *out)
{
    Matrix mat = rlMatrixIdentity();
#if defined(GRAPHICS_API_OPENGL_33) || defined(GRAPHICS_API_OPENGL_ES2)
...
RLAPI void rlGetMatrixViewOffsetStereo(int eye, float *out)
{
    Matrix mat = rlMatrixIdentity();
#if defined(GRAPHICS_API_OPENGL_33) || defined(GRAPHICS_API_OPENGL_ES2)
...
void rlSetMatrixModelview(float *view)
{
#if defined(GRAPHICS_API_OPENGL_33) || defined(GRAPHICS_API_OPENGL_ES2)
    RLGL.State.modelview = FloatToMatrix(view);
#endif
}

// Set a custom projection matrix (replaces internal projection matrix)
void rlSetMatrixProjection(float *projection)
{
#if defined(GRAPHICS_API_OPENGL_33) || defined(GRAPHICS_API_OPENGL_ES2)
    RLGL.State.projection = FloatToMatrix(projection);
#endif
}

// Set eyes projection matrices for stereo rendering
void rlSetMatrixProjectionStereo(float *right, float *left)
{
#if defined(GRAPHICS_API_OPENGL_33) || defined(GRAPHICS_API_OPENGL_ES2)
    RLGL.State.projectionStereo[0] = FloatToMatrix(right);
    RLGL.State.projectionStereo[1] = FloatToMatrix(left);
#endif
}

// Set eyes view offsets matrices for stereo rendering
void rlSetMatrixViewOffsetStereo(float *right, float *left)
{
#if defined(GRAPHICS_API_OPENGL_33) || defined(GRAPHICS_API_OPENGL_ES2)
    RLGL.State.viewOffsetStereo[0] = FloatToMatrix(right);
    RLGL.State.viewOffsetStereo[1] = FloatToMatrix(left);
#endif
}
...
static Matrix FloatToMatrix(float *mat) {
    Matrix result = { 0 };

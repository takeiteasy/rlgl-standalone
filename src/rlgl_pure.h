/* rlgl_pure: Math library agnostic. Modified to only use `Matrix` internally
 *            and any functions in the public api now take or return a pointer
 *            to a float array.
 * Part of: https://github.com/takeiteasy/rlgl-standalone
 */
...
RLAPI void rlSetUniformMatrix(int locIndex, float *mat);                        // Set shader value matrix
...
RLAPI void rlGetMatrixModelview(float *out);                                  // Get internal modelview matrix
RLAPI void rlGetMatrixProjection(float *out);                                 // Get internal projection matrix
RLAPI void rlGetMatrixTransform(float *out);                                  // Get internal accumulated transform matrix
RLAPI void rlGetMatrixProjectionStereo(int eye, float *out);                        // Get internal projection matrix for stereo render (selected eye)
RLAPI void rlGetMatrixViewOffsetStereo(int eye, float *out);                        // Get internal view offset matrix for stereo render (selected eye)
RLAPI void rlSetMatrixProjection(float *proj);                            // Set a custom projection matrix (replaces internal projection matrix)
RLAPI void rlSetMatrixModelview(float *view);                             // Set a custom modelview matrix (replaces internal modelview matrix)
RLAPI void rlSetMatrixProjectionStereo(float *right, float *left);        // Set eyes projection matrices for stereo rendering
RLAPI void rlSetMatrixViewOffsetStereo(float *right, float *left);        // Set eyes view offsets matrices for stereo rendering
